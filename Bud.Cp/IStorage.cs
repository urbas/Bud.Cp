...
namespace Bud {
  ...
  public interface IStorage {
    ...
    /// <summary>
    ///   Returns a cryptographic signature of the given file. The signature is used by
    ///   <see cref="Cp.CopyDir(System.Collections.Generic.IEnumerable{System.Uri},System.Uri,Bud.IStorage)"/> to
    ///   determine whether a file at a target location is the same as the file from a source location.
    /// </summary>
    /// <param name="file">the file whose signature we seek.</param>
    /// <returns>a binary representation of the cryptographic hash.</returns>
